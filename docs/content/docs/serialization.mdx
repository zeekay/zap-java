...
```java
import org.zap.BufferedInputStream;
import org.zap.BufferedOutputStream;
...
tags.set(1, new Text.Reader("zap"));
...
```java
import org.zap.DecodeException;
